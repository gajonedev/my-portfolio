...
- **L'écosystème** : des milliers de plugins couvrent presque tous les besoins courants — sur le papier.

## Ce qu'on ne vous dit pas au moment de signer

### La performance se dégrade, plugin après plugin

Un WordPress frais est correct. Puis on ajoute le constructeur de pages, la galerie, le formulaire, le cache censé compenser les trois premiers… Chaque plugin charge son code sur chaque page. Résultat typique après un an : un site à 4-6 secondes de chargement sur mobile — et [on a vu ce que ça coûte](/blog/site-lent-pourquoi-consequences).
...
Tant que votre besoin rentre dans les cases des plugins, tout va bien. Le jour où vous voulez *votre* logique — un devis calculé selon vos règles, un espace client particulier, une intégration Mobile Money spécifique — on entre dans le bricolage de plugins tordus dans tous les sens.
...
- **SEO d'excellence** : la structure, la vitesse et le balisage sont conçus pour Google dès la première ligne — pas rattrapés par un plugin.
...
- **Et vous restez autonome** : j'intègre un CMS headless (Sanity, Payload) pour que vous modifiiez textes, images et articles vous-même — le confort d'édition de WordPress, sans ses fardeaux.
...
Et si vous avez **déjà** un WordPress qui vous frustre — lent, piraté, impossible à faire évoluer — pas de panique ni de précipitation : mon [audit](/services/audit-optimisation) établit ce qui peut être sauvé, et une éventuelle refonte migre votre contenu et préserve votre référencement acquis.

Un [site vitrine sur-mesure démarre à 170 000 FCFA](/tarifs) — moins loin du devis WordPress qu'on ne l'imagine, pour un résultat qui n'a rien à voir. [Parlons de votre projet](/contact) : devis détaillé sous 24h.

---

*Néhémie Gandonou développe des sites sur-mesure rapides et bien référencés depuis Cotonou — et recommande encore WordPress quand c'est honnêtement le bon choix.*
